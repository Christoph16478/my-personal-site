...
\cvitem{2021}{\textbf{LPIC-1 LInux Bootcamp,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{Shell-Skripting, Paketverwaltung, Benutzerverwaltung, Dateien und Verzechnisse, Dateisysteme und Festplattenmanagement, Logical Volume Manager, Hardware und Systemstart verwalten, Prozessverwaltung, Netzwerkkonfiguration}

\cvitem{2020}{\textbf{C++ Komplettkurs: Praxisnahe Programmierung,} \textit{Online-Lernplattform Udemy}}
...
\cvitem{2020}{\textbf{Java Meisterklasse für Softwareentwickler,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{Databases, Java Network Programming, Debugging and Unit Testing, Regularand Lambda Expresions, Input und Output, JavaFX, Collections, Generics}
