...
\cvitem{03/2020}{\textbf{Software Entwickler (XML/XBRL Standards Maintainer)} \textit{Altova GmbH in Wien,} AT}
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}} % Changes the symbol used for lists
\cvlistitem{Prozessautomatisierung vom Download über die Aufbereitung bishin zur Integration von XBRL Taxonomien in das Taxonomy Management System mit Python: Updates bezüglich Reporting Frameworks aus dem Finanzsektor, Herunterladen und Anpassung der Taxonomien, Validierung und Integrierung von Taxonomiepaketen, Auffindung von Updates des EFM, Hinzufügung neuer EDGAR Regeln zum EDGAR Support, Auffindung von Updates bezüglich Schemata und XML Standards}
...
\renewcommand{\listitemsymbol}{\textcolor{black}{-~}} % Changes the symbol used for lists
\cvlistitem{Betreuung von ungefähr 20 Gästen in einer Station: Speisenservice, Weinservice, Tische eindecken, Mise en Place vorbereiten, Filetieren und Flambieren am Tisch des Gastes}
...
\cvlistitem{Schwerpunkte: Programmierung, Webentwicklung, Projektmanagement, Informationsmodellierung, Digitale Langzeitarchivierung und Datenmanagement, X-Technologien, Digitale Editionen}

\cvitem{2014--2017}{\textbf{Bachelor Philosophie,} \textit{Karl-Franzens Universität in Graz, AT}}
\cvlistitem{Schwerpunkte: Erkenntnistheorie, Logik, Ethik, Philosophie des Geistes, Wissenschaftstheorie, Ästhetik, Metaphysik/Ontologie}

\cvitem{2004--2010}{\textbf{Matura als Tourismuskaufmann,} \textit{Tourismusschulen in Bad Gleichenberg, AT}}
\cvlistitem{Schwerpunkte: Küchenführung und -organisation, Restaurantführung, Rechnungswesen und Controlling, Marketing im Tourismus, Touristisches Management}

\section{Weiterbildung}

\cvitem{2020}{\textbf{The Complete Ruby on Rails Developer Course,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{Erste Schritte mit Ruby on Rails: Strings, Zahlen, Arrays, Iteratoren, Schleifen, Objektorientierte Programmierung, Aufbau einer Ruby on Rails Applikation, Styling und CRUD Operationen}

\cvitem{2020}{\textbf{C Kurs: Praxisnahe Programmierung für Einsteiger,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{Variablen und Datentypen, Abfragen und Logik, Schleifen, Funktionen und Header, Makefile, Release, Debug, einfache Zeiger, Arrays, Zeiger Arrays, Strings, Strukturen, Schreiben und Lesen von Dateien, Datenstrukturen}

\cvitem{2020}{\textbf{Fortgeschrittene Python Programmierung,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{Funktionen, Dekoratoren, Lambda Ausdrücke, Exception and Error Handling, Objektorientierung, Cython, Multiprocessing and Multithreading, Debugging, Logging, Profiling, Timing and Unit Testing}

%\cvitem{2019}{\textbf{The Advanced Web Developer Bootcamp} \textit{Online-Lernplattform Udemy}}
%\cvlistitem{CSS Pseudoklassen und Animationen, Flexbox, AJAX, Testing mit Jasmine, OOP mit JavaScript, Node.js, MongoDB, ES16/17, D3.js, React}

%\cvitem{2019}{\textbf{Der komplette Webentwickler Kurs} \textit{Online-Lernplattform Udemy}}
%\cvlistitem{HTML, CSS, JavaScript, jQuery, Twitter Bootstrap, Wordpress, PHP, MySQL, Python}

%\cvitem{2019}{\textbf{Web Design for Web Developers} \textit{Online-Lernplattform Udemy}}
%\cvlistitem{Design Regeln und Richtlinien, Farben, Bilder, Schriftarten, visuelle Hierarchie der Objekte}
...
\cvitem{}{\textbf{Betriebssysteme:} Windows 10, Ubuntu 19.10 LTS}
...
%\cvitem{}{Erfahrung und Fähigkeiten für Teamarbeit.}
