...
\cvlistitem{Finding updates to XML/XBRL taxonomies in the financial sector, downloading and customizing taxonomies, validating and integrating packages, finding EFM updates, adding new EDGAR rules to EDGAR support, finding schema and XML standards updates, maintaining XBRL certification, automating the process with Python where possible}
