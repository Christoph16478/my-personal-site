...
\cvitem{2020}{\textbf{The Complete Ruby on Rails Developer Course,} \textit{online learning platform Udemy}}
\cvlistitem{First steps with Ruby on Rails: strings, numbers, arrays, iterators, loops, object oriented programming, structure of a Ruby on Rails application, styling and CRUD operations}

\cvitem{2020}{\textbf{C Kurs: Praxisnahe Programmierung für Einsteiger,} \textit{online learning platform Udemy}}
\cvlistitem{Varaiables and datatypes, logic, loops, functions, header files, makefile, release, Debug, simple pointer, arrays, pointer arrays, strings, structures, writting and reading of files, data structures}
