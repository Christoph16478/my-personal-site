...
\cvlistitem{Process automation from download to preparation of XBRL taxonomies in the Taxonomy Management System with Python: Updates on XML/XBRL taxonomies in the financial sector, download and customization of taxonomies, validation and integration of packages, finding EFM updates, adding new EDGAR rules to EDGAR support, finding schema and XML standards updates, maintaining XBRL certification}
...
\cvitem{2004--2010}{\textbf{School-leaving certificate in the tourism industry,} \textit{Tourism School Bad Gleichenberg, AT}}
\cvlistitem{Kitchen management and organization, restaurant management, accounting and controlling, marketing in tourism, tourism management}

\section{Motivation}

\cvitem{2021}{\textbf{LPIC-1 Linux Bootcamp,} \textit{online learning platform Udemy}}
\cvlistitem{shell-scripting, package management, user administration, Files and , file systems and disk management, logical volume manager, hardware system startup administration, process management, network configuration}

\cvitem{2020}{\textbf{C++ Complete Course: Practical Programming,} \textit{online learning platform Udemy}}
\cvlistitem{variables and datatypes, queries and logic, loops, functions and headers, makefile, release, debugging, simple pointers, arrays, pointer arrays, strings, structures, reading and writing files, data structures}

\cvitem{2020}{\textbf{Java Masterclass for Softwaredevelopers,} \textit{Online-Lernplattform Udemy}}
\cvlistitem{databases, networkprogramming, debugging and unit testing, regular- and lambda-expressions, I/O, JavaFX, collections, generics}
